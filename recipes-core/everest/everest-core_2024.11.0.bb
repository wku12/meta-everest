...
SRC_URI = "git://github.com/wku12/everest-core.git;branch=add_rejection_reason_interface_to_payment_terminal;protocol=https \
           file://everest.service \
           "

S = "${WORKDIR}/git"

SRCREV = "35da260fba30ed12cc7eb3cbf6041497a26d22e4"
